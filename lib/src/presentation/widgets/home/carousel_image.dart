...
class CarouselImage extends StatelessWidget {
  ...
  final carousel_controller.CarouselSliderController _controller =
      carousel_controller.CarouselSliderController();
...
class CarouselImageWidget extends StatelessWidget {
  const CarouselImageWidget({
    super.key,
    required carousel_controller.CarouselSliderController controller,
    required this.index,
