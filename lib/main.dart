  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => CartBloc(UserRepository())),
        BlocProvider(
        ...
        BlocProvider(create: (context) => SearchBloc(ProductsRepository())),
        BlocProvider(
        ...
        BlocProvider(create: (context) => UserRatingCubit(AccountRepository())),
        BlocProvider(
        ...
        BlocProvider(
          create: (context) => AdminChangeOrderStatusCubit(AdminRepository()),
        ),
        BlocProvider(
